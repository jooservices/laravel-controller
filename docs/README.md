# JOOservices Laravel Controller Documentation
...
- [Request Lifecycle](./00-architecture/03-request-lifecycle.md)
- [Ecosystem Comparison](./00-architecture/04-ecosystem-comparison.md)
...
- [Basic Controller](./03-examples/basic-controller.md)
- [Pagination Patterns](./03-examples/pagination-patterns.md)
- [Configuration Recipes](./03-examples/configuration-recipes.md)
